...
(function(mod) {
  ...
  function drawSelectionRange(cm, range, output) {
    ...
    function drawForLine(line, fromArg, toArg) {
      ...
      iterateBididivs(getOrder(lineObj), fromArg || 0, toArg == null ? lineLen : toArg, function(from, to, dir) {
  ...
  function iterateBididivs(order, from, to, f) {
  ...
  // (left-to-right), or an array of divs ({from, to, level}
